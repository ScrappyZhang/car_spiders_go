...
//<a href="/2sc/china/a0_0msdgscncgpi1ltocsp2ex/" class="page-item-next"><i></i>下一页</a>
//获取下一页链接
func GetNextPageUrl(doc *goquery.Document) (val string, exists bool) {
	return doc.Find(".page .page-item-next").Attr("href")
}

//<a href="/2sc/china/a0_0msdgscncgpi1ltocsp1ex/" class="current">1</a>
//当前页页码
